		...
		<div class="container py-xl-4 py-lg-2">
					...
					<table class="timetable_sub">
						...
						?>
							<tr class="rem1">
								...
								<td class="invert"><?php echo number_format($row_fetch_giohang['giasanpham']).'$' ?></td>
							...
							?>
							<tr>
								<td colspan="7">Total price : <?php echo number_format($total).'$' ?></td>

							</tr>
							<tr>
								<td colspan="7"><input type="submit" class="btn btn-success" value="Update cart" name="capnhatsoluong">
								<?php 
								...
								?>
								<input type="submit" class="btn btn-primary" value="Payments" name="thanhtoandangnhap">
			...
			<div class="checkout-left">
				<div class="address_form_agile mt-sm-5 mt-4">
					<h4 class="mb-sm-4 mb-3">Add shipping address</h4>
					<form action="" method="post" class="creditly-card-form agileinfo_form">
						<div class="creditly-wrapper wthree, w3_agileits_wrapper">
							<div class="information-wrapper">
								<div class="first-row">
									...
									<div class="controls form-group">
										<select class="option-w3ls" name="giaohang">
											...
											<option value="1">Payment Atm</option>
								...
								?>
								<input type="submit" name="thanhtoan" class="btn btn-success" style="width: 20%" value="Payments">
